...
public:
    ...
    double sumOfSquaredDiffPenalty1, sumOfSquaredDiffPenalty2; // penalizacion de suma de diferencias al cuadrado
    double chargeDiffPenalty;                                  // penalizacion de la diff entre (q1 / q2) y PROP_CHARGE
    double widthDiffPenalty;                                   // penalizacion de la diff entre (p1 / p2) y PROP_WIDTH
    double noisePropPenalty;                                   // penalizacion de la porcion de la señal que esta dentro de [-MINIMUM_CHARGE, MINIMUM_CHARGE]
    bool valid;
