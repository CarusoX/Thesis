...
El procesamiento transforma las señales crudas registradas por el instrumento en una lista de gotas con sus propiedades. Para ello se emplean dos programas que se ejecutan de manera secuencial: el primero realiza un preprocesamiento de las señales y el segundo extrae las gotas y calcula sus características. Un pulso es un recorte de la señal que representa la variación característica de corriente producida por el paso de una única gota a través del anillo y su impacto en la placa. El flujo general consta de cinco pasos principales:
