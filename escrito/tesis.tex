...
\title{\textbf{Desarrollo de un sistema eficiente para el procesamiento gotas cargadas eléctricamente en tormentas}}
...
Al analizar el rendimiento del código, se encontraron 2 areas de potenciales mejoras:
...
private:
    std::queue<int> mainQueue;
    std::deque<int> minDeque;  // Orden decreciente
    std::deque<int> maxDeque;  // Orden creciente
