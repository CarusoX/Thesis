...
\begin{frame}{Cambios en la detección de pulsos - Parte 1}
  Aprovechar que los pulsos miden maximo 400 puntos
  \begin{center}
...
\begin{frame}{Cambios en la detección de pulsos - Parte 3}
  Buscamos el punto critco del sensor 1 entre los primeros 400 puntos, pero permitimos que el punto critico del sensor 2 esté en la siguiente ventana
  \begin{center}
...
\begin{frame}{Cambios en la detección de pulsos - Parte 5}
  Busqueda con MinMaxQueue de tamaño 100 sobre el sensor 2 para obtener el mejor critico para cada punto del sensor 1
  \begin{center}
...
\begin{frame}{Cambios en la detección de pulsos - Parte 7}
  En caso de que sea valido, marcamos como utilizado todos los puntos del pulso y reiniciamos la busqueda en la misma ventana
  \begin{center}
