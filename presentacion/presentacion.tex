...
\begin{frame}{Análisis de complejidad}
  \begin{itemize}
    ...
    \item Cada ventana tiene tamaño $V = 800$ puntos
    \item Se marcan como mínimo 4 puntos por búsqueda $\Rightarrow$ cota superior de $300/4 = 75$ búsquedas por ventana
  ...
  \textcolor{red}{\textbf{Reducción de constante: de 100000 a 200}}
\end{frame}
