...
\begin{frame}{Detección de pulsos}
  ...
  \begin{itemize}
    ...
    \item Para cada umbral, busca pares de puntos consecutivos que superen el umbral en ambas señales, con separación máxima de 100 puntos entre señales
  \end{itemize}
...
\begin{frame}{Beneficios de la refactorización}
  \begin{columns}[t]
    \column{0.5\textwidth}
    \vspace{0pt}
